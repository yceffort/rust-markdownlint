...
후속 실행: [musl 출력 버퍼링 계획과 결과](optimization-plan-2026-09-07.md). 동일 세션의 기준 대비 개선을 별도로 기록했으며, 아래 세 도구 표는 출력 변경 전 측정이다.
